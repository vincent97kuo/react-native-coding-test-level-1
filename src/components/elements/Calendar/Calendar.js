...
export default class Calendar extends PureComponent {
    ...
    constructor(props) {
        ...
        this.onRenderDay = this.onRenderDay.bind(this);
        this.getVisibleDates = this.getVisibleDates.bind(this);
    ...
    getVisibleMonthAndYear() {
        ...
        if (!visibleMonths || !visibleYears) {
            ...
            if (dates) {
                ...
                return `${this.formatMonth(firstDate)}, ${this.formatYear(firstDate)}`;
            }
            return undefined;
        }
    ...
    updateVisibleMonthAndYear(setYear) {
        ...
        visibleDates.forEach((date) => {
            ...
            const year = this.formatYear(date);
        ...
        this.setState({
            ...
            let _month = this.getVisibleMonthAndYear();
            if (this.state.lastSelectedMonth !== _month) {
                this.setState({
                    lastSelectedMonth: _month
                })
                setYear(_month);
            }
        });
    ...
    onSelectDay(index, onSelectDate) {
    ...
    onRenderDay(index, width, setYear) {
        ...
        this.setState({
            ...
            if (allDatesHaveRendered) {
                ...
                this.updateVisibleMonthAndYear(setYear);
            }
        });
    };

    onScroll = (event, setYear) => {
        this.setState({ scrollPositionX: event.nativeEvent.contentOffset.x }, () => {
            this.updateVisibleMonthAndYear(setYear);
        });
    };
            ...
            <View style={{
                ...
                >
                    <Dates
                        ...
                        onSelectDay={(index) => {
                            this.onSelectDay(index, this.props.onSelectDate)
                        }}
                        onRenderDay={(index, width) => {
                            this.onRenderDay(index, width, setYear)
                        }}
                    />
                </ScrollView>
            </View>
